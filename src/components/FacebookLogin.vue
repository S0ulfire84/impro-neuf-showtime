...
<script>
import facebookWhiteFull from "../assets/facebook-icons/white-full.png";
import facebookWhiteMin from "../assets/facebook-icons/white-min.png";
import facebookColorFull from "../assets/facebook-icons/color-full.png";
import facebookColorMin from "../assets/facebook-icons/color-min.png";
